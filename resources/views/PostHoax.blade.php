        ...
        <header class="header-area">
            ...
            <div class="navbar-area">
                <div class="sinmun-mobile-nav">
                    <div class="logo">
                        <a href="index.html"><img src="resources/sinmun/assets/img/logo.png" alt="logo"></a>
                    </div>
                </div>
                ...
                <div class="sinmun-nav">
                    <div class="container">
                        <nav class="navbar navbar-expand-md navbar-light">
                            <a class="navbar-brand" href="index.html"><img src="resources/sinmun/assets/img/logo.png" alt="logo"></a>
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item"><a href="#" class="nav-link active">Pages</a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item"><a href="#" class="nav-link active">Post Fomate</a>
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="nav-item"><a href="single-post-3.html" class="nav-link active">Single Post 3</a></li>
                                    ...
                                    <article class="comment-body">
                                        <footer class="comment-meta">
                                            <div class="comment-author vcard">
                                                <img src="resources/sinmun/assets/img/author1.jpg" class="avatar" alt="image">
                                                <b class="fn">Sinmun</b>
                            ...
                            <div class="comment-respond">
                                ...
                                <form class="comment-form">
                                    ...
                                    <p class="comment-form-cookies-consent">
                                        ...
                                        <label resources/sinmun/="wp-comment-cookies-consent">Save my name, email, and website in this browser for the next time I comment.</label>
                                    </p>
                                    <p class="form-submit">

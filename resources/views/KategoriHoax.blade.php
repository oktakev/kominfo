...
<html lang="zxx">
    <head>
        ...
        <link rel="icon" type="image/png" href="resources/sinmun/resources/sinmun/assets/img/favicon.png">
    </head>
                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div class="single-category-news">
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="#"><img src="resources/sinmun/assets/img/6.jpg" alt="image"></a>
                        ...
                        <div class="single-category-news">
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="#"><img src="resources/sinmun/assets/img/5.jpg" alt="image"></a>
                        ...
                        <div class="single-category-news">
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="#"><img src="resources/sinmun/assets/img/4.jpg" alt="image"></a>
                        ...
                        <div class="single-category-news">
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="#"><img src="resources/sinmun/assets/img/3.jpg" alt="image"></a>
                        ...
                        <div class="single-category-news">
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="#"><img src="resources/sinmun/assets/img/2.jpg" alt="image"></a>

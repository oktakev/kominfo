...
Route::get('/admin/laporan/laporanIsu', 'App\Http\Controllers\backend\LapIsu@index');
Route::get('/admin/laporan/laporanKategori', 'App\Http\Controllers\backend\LapKategori@index');

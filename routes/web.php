...
Route::post('/admin/laporan/laporanKategori/update', 'App\Http\Controller\backend\LapKategori@update');
...
Route::post('/admin/galeri/categories/update', 'App\Http\Controller\backend\Categories@update');
